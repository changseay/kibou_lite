  ...
  <body>
    ...
    <nav class="blog-nav">
      <div class="nav-container">
        <a class="blog-nav-item" href="<?php $this->options->siteUrl(); ?>index.php"><?php if ($this->is('index')): _e('首页'); else: $this->options->title(); endif; ?></a>
      ...
      <div class="blog-title">
        <div class="blog-container">
          ...
          <p class="blog-post-meta">
            <?php if ($this->is('page')): ?><?php $this->fields->pagedesc(); ?><?php endif; ?>
            <?php if ($this->is('post')): ?><?php $this->category(', '); ?>&nbsp;• 
